      ...
      <div className="container mx-auto max-w-4xl text-center">
        ...
        {projects.map((project) => (
          <motion.a
            ...
            className="block group max-w-xl mx-auto rounded-2xl bg-card border border-indigo-400/20 backdrop-blur-md shadow-xl hover:shadow-indigo-500/30 transition-all duration-500"
